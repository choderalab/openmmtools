...
version = openmmtools.version.short_version
# The full version, including alpha/beta/rc tags.
release = openmmtools.version.short_version
...
latex_documents = [
  ('index', 'openmmtools.tex', u'OpenMM Tools Documentation',
...
man_pages = [
    ('index', 'openmmtools', u'openmmtools',
     [u'John Chodera'], 1)
]
...
texinfo_documents = [
  ('index', 'openmmtools', u'OpenMM Tools Documentation',
   u'John Chodera', 'openmmtools', 'Various tools for OpenMM.',
   'Miscellaneous'),
]
