...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "yank.multistate.mixing._mix_replicas",
        "sources": [
            "./Yank/multistate/mixing/_mix_replicas.pyx"
        ]
    },
    "module_name": "yank.multistate.mixing._mix_replicas"
}
END: Cython Metadata */
...
#define __PYX_HAVE__yank__multistate__mixing___mix_replicas
#define __PYX_HAVE_API__yank__multistate__mixing___mix_replicas
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'yank.multistate.mixing._mix_replicas' */
...
static long __pyx_f_4yank_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(long, long, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "yank.multistate.mixing._mix_replicas"
extern int __pyx_module_is_main_yank__multistate__mixing___mix_replicas;
int __pyx_module_is_main_yank__multistate__mixing___mix_replicas = 0;

/* Implementation of 'yank.multistate.mixing._mix_replicas' */
...
/* "Yank/multistate/mixing/_mix_replicas.pyx":10
...
static PyObject *__pyx_pw_4yank_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static long __pyx_f_4yank_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(long __pyx_v_nswap_attempts, long __pyx_v_nstates, __Pyx_memviewslice __pyx_v_replica_states, __Pyx_memviewslice __pyx_v_u_kl, __Pyx_memviewslice __pyx_v_Nij_proposed, __Pyx_memviewslice __pyx_v_Nij_accepted, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "Yank/multistate/mixing/_mix_replicas.pyx":14
 *     cdef long i, j, istate, jstate, tmp_state
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":15
 *     cdef double log_P_accept
 *     for swap_attempt in range(nswap_attempts):
 *         i = <long>(drand48()*nstates)             # <<<<<<<<<<<<<<
 *         j = <long>(drand48()*nstates)
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":16
 *     for swap_attempt in range(nswap_attempts):
 *         i = <long>(drand48()*nstates)
 *         j = <long>(drand48()*nstates)             # <<<<<<<<<<<<<<
 *         istate = replica_states[i]
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":17
 *         i = <long>(drand48()*nstates)
 *         j = <long>(drand48()*nstates)
 *         istate = replica_states[i]             # <<<<<<<<<<<<<<
 *         jstate = replica_states[j]
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":18
 *         j = <long>(drand48()*nstates)
 *         istate = replica_states[i]
 *         jstate = replica_states[j]             # <<<<<<<<<<<<<<
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":19
 *         istate = replica_states[i]
 *         jstate = replica_states[j]
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":20
 *         jstate = replica_states[j]
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 *             continue             # <<<<<<<<<<<<<<
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":21
 *         if (isnan(u_kl[i, istate]) or isnan(u_kl[i, jstate]) or isnan(u_kl[j, istate]) or isnan(u_kl[j, jstate])):
 *             continue
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])             # <<<<<<<<<<<<<<
 *         Nij_proposed[istate, jstate] +=1
 ...
 */
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":22
 *             continue
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 *         Nij_proposed[istate, jstate] +=1             # <<<<<<<<<<<<<<
 *         Nij_proposed[jstate, istate] +=1
 ...
 */
    ...
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_proposed.data + __pyx_t_24 * __pyx_v_Nij_proposed.strides[0]) ) + __pyx_t_25 * __pyx_v_Nij_proposed.strides[1]) )) += 1;
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":23
 *         log_P_accept = - (u_kl[i, jstate] + u_kl[j, istate]) + (u_kl[j, jstate] + u_kl[i, istate])
 *         Nij_proposed[istate, jstate] +=1
 *         Nij_proposed[jstate, istate] +=1             # <<<<<<<<<<<<<<
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 ...
 */
    ...
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_proposed.data + __pyx_t_26 * __pyx_v_Nij_proposed.strides[0]) ) + __pyx_t_27 * __pyx_v_Nij_proposed.strides[1]) )) += 1;
    ...
    /* "Yank/multistate/mixing/_mix_replicas.pyx":24
 *         Nij_proposed[istate, jstate] +=1
 *         Nij_proposed[jstate, istate] +=1
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):             # <<<<<<<<<<<<<<
 *             tmp_state = replica_states[i]
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":25
 *         Nij_proposed[jstate, istate] +=1
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 *             tmp_state = replica_states[i]             # <<<<<<<<<<<<<<
 *             replica_states[i] = replica_states[j]
 ...
 */
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":26
 *         if(log_P_accept>=0 or drand48()<exp(log_P_accept)):
 *             tmp_state = replica_states[i]
 *             replica_states[i] = replica_states[j]             # <<<<<<<<<<<<<<
 *             replica_states[j] = tmp_state
 ...
 */
      ...
      *((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_30 * __pyx_v_replica_states.strides[0]) )) = (*((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_29 * __pyx_v_replica_states.strides[0]) )));
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":27
 *             tmp_state = replica_states[i]
 *             replica_states[i] = replica_states[j]
 *             replica_states[j] = tmp_state             # <<<<<<<<<<<<<<
 *             Nij_accepted[istate,jstate] += 1
 ...
 */
      ...
      *((long *) ( /* dim=0 */ (__pyx_v_replica_states.data + __pyx_t_31 * __pyx_v_replica_states.strides[0]) )) = __pyx_v_tmp_state;
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":28
 *             replica_states[i] = replica_states[j]
 *             replica_states[j] = tmp_state
 *             Nij_accepted[istate,jstate] += 1             # <<<<<<<<<<<<<<
 *             Nij_accepted[jstate,istate] += 1
 ...
 */
      ...
      *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Nij_accepted.data + __pyx_t_32 * __pyx_v_Nij_accepted.strides[0]) ) + __pyx_t_33 * __pyx_v_Nij_accepted.strides[1]) )) += 1;
      ...
      /* "Yank/multistate/mixing/_mix_replicas.pyx":29
 *             replica_states[j] = tmp_state
 *             Nij_accepted[istate,jstate] += 1
 *             Nij_accepted[jstate,istate] += 1             # <<<<<<<<<<<<<<
 *     return 0
 ...
 */
  ...
  /* "Yank/multistate/mixing/_mix_replicas.pyx":30
 *             Nij_accepted[istate,jstate] += 1
 *             Nij_accepted[jstate,istate] += 1
 *     return 0             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_4yank_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4yank_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("yank.multistate.mixing._mix_replicas._mix_replicas_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4yank_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(__pyx_self, __pyx_v_nswap_attempts, __pyx_v_nstates, __pyx_v_replica_states, __pyx_v_u_kl, __pyx_v_Nij_proposed, __pyx_v_Nij_accepted);
...
static PyObject *__pyx_pf_4yank_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_nswap_attempts, long __pyx_v_nstates, __Pyx_memviewslice __pyx_v_replica_states, __Pyx_memviewslice __pyx_v_u_kl, __Pyx_memviewslice __pyx_v_Nij_proposed, __Pyx_memviewslice __pyx_v_Nij_accepted) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_4yank_10multistate_6mixing_13_mix_replicas__mix_replicas_cython(__pyx_v_nswap_attempts, __pyx_v_nstates, __pyx_v_replica_states, __pyx_v_u_kl, __pyx_v_Nij_proposed, __pyx_v_Nij_accepted, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "yank.multistate.mixing._mix_replicas.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "yank.multistate.mixing._mix_replicas.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "yank.multistate.mixing._mix_replicas.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "yank.multistate.mixing._mix_replicas._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_mix_replicas_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4yank_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct_or_indirect); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(1, 285, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(1, 286, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_strided_and_indirect); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(1, 287, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_direct); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(1, 290, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__23 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_indirect); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(1, 291, __pyx_L1_error)
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__mix_replicas(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_mix_replicas' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_yank__multistate__mixing___mix_replicas) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "yank.multistate.mixing._mix_replicas")) {
      if (unlikely(PyDict_SetItemString(modules, "yank.multistate.mixing._mix_replicas", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "Yank/multistate/mixing/_mix_replicas.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 285, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 290, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init yank.multistate.mixing._mix_replicas", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init yank.multistate.mixing._mix_replicas");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
