...
static PyMethodDef __pyx_methods[] = {
  {"_mix_replicas_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11openmmtools_10multistate_6mixing_13_mix_replicas_1_mix_replicas_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init openmmtools.multistate.mixing._mix_replicas", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
